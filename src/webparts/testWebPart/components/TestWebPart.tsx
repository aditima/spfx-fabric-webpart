...
export default class TestWebPart extends React.Component<ITestWebPartProps, {}> {
  public render(): React.ReactElement<ITestWebPartProps> {
    ...
    const cardsData = [
      ...
      { name: 'Kristin Patterson', title: 'Marketing Specialist', bioText: bioText, imageUrl: getImageUrl('Kristin Patterson'), backgroundUrl: getBackgroundUrl('Kristin Patterson') },
